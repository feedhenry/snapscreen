...
Below you'll find information about performing common tasks. The full, up-to-date version of this README is available [here](https://github.com/react-community/create-react-native-app/blob/master/react-native-scripts/template/README.md).
...
Follow the instructions displayed to run the app in [Expo](https://expo.io). It will reload if you save edits to your files, and you will see build errors and logs in the terminal.
